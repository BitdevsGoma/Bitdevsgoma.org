...
* Pourquoi utiliser Regtest pour développer ?
...
* Récupérer une adresse de réception
* Miner vers cette adresse
* Vérifier le solde
...
* Envoyer des BTC du wallet A vers le wallet B
* Observer la transaction avant confirmation
* Miner un bloc pour la confirmer

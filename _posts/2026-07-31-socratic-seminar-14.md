...
* Connexion au nœud
* Lecture des informations de la blockchain
...
* Construction d'une transaction simple
...
* Vérification du solde d'un portefeuille
* Création d'une transaction de démonstration en Regtest
